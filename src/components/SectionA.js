    ...
    return (
      <section id="AboutMe" className="SectionA">
        <div>
          ...
          <p>
            &emsp;At my 4 month of Internship I have been exposed to a
          ...
          <p>
            ...
            learn alot of things in web development as we thrive to be the best.
            Technology used (Docker, Elixir, React, Ruby, Terraform, Kubernetes,
            Vagrant, Ansible, Nginx, AWS, GCP, DO, Postgres, MongoDB, Redis){" "}
          </p>
          <p>
            &emsp;I currently work on a outsourcing company partnered with AWS,
            I work their as a Software Engineer
          </p>
          <p>
            &emsp;Since we strictly have tests in our API's at my previous
            company I decided to focus more on testing libraries used are Jest,
            react-testing-library, mocha, chai, cypress.
          </p>
          <p>
            I'm also a certified AWS cloud practiioner and aiming to be a AWS
            Solutions Architect
          </p>
          <p>
            &emsp;I spend time learning new things via reading documentations
